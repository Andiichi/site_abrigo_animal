...
def login_view(request):
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            messages.success(request,'Login realizado com sucesso!', extra_tags='success, login')
...
def logout_view(request):
    if request.method == "POST":
        ...
        messages.success(request, "Logout realizado com sucesso.", extra_tags='success, logout')
